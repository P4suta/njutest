...
| `touch` | `target`, `tests`, `sites`, `loose`, `infected`, `entered` | per target: how many of its tests reached a mutation, how many distinct mutations anything of it reached, how many were reached where nothing named a test, how many it saw a guard's two branches differ over, and how many distinct items anything of it entered the body of |
