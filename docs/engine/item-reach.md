...
Why the markers are placed where they are is [ADR 0027](../adr/0027-an-item-is-entered-where-its-body-starts.md).
...
[ADR 0027](../adr/0027-an-item-is-entered-where-its-body-starts.md#consequences) has the numbers and the load they were taken under.
