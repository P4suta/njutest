...
**Status: every milestone is done. What remains of M8 is the tag itself, which is a decision rather than a change: see `docs/release.md`.** The user's decisions: one workspace, the engine first,
