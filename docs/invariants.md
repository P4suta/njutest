...
| repository-claims | every repository claim names what it says on every push | `Resolution` | `claims` | none | `ROTTEN`, `MOVED` | none | none | claims in skipped targets, and whether a claim's reason is true or adequate |
