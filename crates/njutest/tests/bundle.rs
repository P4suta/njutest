...
use njutest::app::diagnostics::{MANIFEST_NAME, copy, copy_tree, record, run};
use njutest::app::reports::DOCUMENT_NAME;
use njutest::cli::{Diagnostics, Environment};
...
fn a_bundle_with_no_optional_evidence_names_every_absence_exactly() {
    ...
    assert_eq!(
        ...
        format!(
            ...
            njutest::trace::FILE_NAME,
            njutest::trace::OUTPUT_DIRECTORY_NAME,
        ),
