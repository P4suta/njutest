...
use njutest::build::{BuildOptions, Built, Cargo, Flavour, Selection, build};
use njutest::trace::{MemorySink, Recorder, StartRecord};
...
fn the_build_says_what_it_did_into_the_trace_without_saying_what_the_variables_hold() {
    let trace = Recorder::new(
        njutest::trace::Sink::Memory(MemorySink::unbounded()),
        njutest::trace::Clock::Wall,
        StartRecord::of(
            "run",
