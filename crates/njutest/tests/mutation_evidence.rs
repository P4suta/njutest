...
use njutest::assure::mutation::{Consulted, Disposition, Evidence, MutationOptions, keep, reuse};
use njutest::evidence::store::{self, Standing};
...
fn measured(name: &str) -> njutest::assure::baseline::Measured {
    njutest::assure::baseline::Measured {
        target: njutest::targets::Target {
            id: njutest::targets::target_id("core", njutest::targets::UnitKind::Lib, "core", name)
                .expect("the fixture target identity"),
            package: "core".to_owned(),
            unit: njutest::targets::UnitKind::Lib,
