...
//! What a run is, as one number.
//! Two runs share an identity exactly when nothing that could change what the tests say has changed.
...
use njutest::evidence::digest::{EVIDENCE_DOMAIN, Fields, Inputs, Mode, identity};
