...
///
/// Reporting an abandoned directory and leaving it there tells a reader they have rubbish and gives them nothing to sweep it with — and `--gc` is the flag they would reach for.
/// It collects here too, and without it the line says what would go rather than what went.
fn temporary(
    environment: &Environment,
    collect: bool,
    stdout: &mut dyn Write,
