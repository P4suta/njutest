...
/// Why an observed exchange could not be given the v1 identity its bytes require.
...
///
/// Nothing is proposed about an exchange that did not happen, and nothing is proposed about a protocol the interposer did not read: a question put to an answer nobody parsed is a question about a program this run never saw.
/// # Errors
