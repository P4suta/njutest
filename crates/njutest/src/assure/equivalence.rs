...
///
/// # Errors
/// Whatever stopped the tree being copied or built.
/// A mutation whose premises do not hold costs no build and is decided here.
pub fn prove(
    proving: &Proving<'_>,
    asked: &[Asked],
...
///
/// # Errors
/// Returns [`EquivalenceError::DuplicateDecision`] when the proof ledger is not a function from display identity to decision.
pub fn settle(
