...
/// The domain hashed first for a run's identity. The recipe version is in the name: a future recipe becomes `njutest-evidence-v4` so a v3 identity can never be mistaken for a v4 one.
