...
///
/// Enough of the language to colour a line and no more: a diagnostic shows a
/// handful of lines, and a reader looking at them wants the string literals to
/// look like string literals. Anything that needs a parser to tell apart is
/// left as ordinary code, because guessing wrong is worse than not colouring.
