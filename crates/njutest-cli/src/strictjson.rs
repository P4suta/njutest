...
/// Parses one complete JSON value and rejects duplicate object keys instead of
/// accepting `serde_json`'s last-key-wins projection.
///
/// # Errors
...
/// Parses one complete UTF-8 JSON byte stream and rejects duplicate object
/// keys at every depth.
///
/// # Errors
