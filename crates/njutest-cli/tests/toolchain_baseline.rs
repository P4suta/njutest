...
fn a_workspace_that_does_not_compile_is_a_finding_and_not_an_error() {
    let broken = njutest_cli::error::RunnerError::from(rust_mutants::EngineError::from(
    ...
    let elsewhere = njutest_cli::error::RunnerError::from(rust_mutants::EngineError::from(
