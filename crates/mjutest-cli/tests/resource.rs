...
use mjutest_cli::provider::{ProviderErrorKind, Request, VERSION};
use mjutest_cli::resource::{ResourceError, admissible, visible};
...
fn a_provider_may_not_decide_what_every_test_process_measures() {
    for name in [
        ...
        assert_eq!(refused.code().code, "MJ5005", "{name}");
