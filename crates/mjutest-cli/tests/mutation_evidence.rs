...
fn measured(name: &str) -> mjutest_cli::assure::baseline::Measured {
    mjutest_cli::assure::baseline::Measured {
        ...
        status: mjutest_cli::report::TargetStatus::Passed,
        duration_ms: 1,
        tests: 1,
        message: None,
    }
...
fn a_kill_is_confirmed_against_the_test_that_found_it_and_not_against_the_rest() {
    use mjutest_cli::assure::mutation::{narrowed, request_for};
