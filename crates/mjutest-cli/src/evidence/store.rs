...
pub const SCHEMA: &str = "mjutest-mutation-evidence-v1";
...
/// Records what this run established about one mutant, replacing whatever was there. A record is contradicted by being replaced; nothing else removes one.
///
/// # Errors
