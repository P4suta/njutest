...
impl Recorder {
    ...
    ///
    /// This is what a diagnostics bundle reads from a run that asked for no
    /// trace: the ring holds the last moments of the run, and nothing had to
    /// be written to disk to have them.
    #[must_use]
