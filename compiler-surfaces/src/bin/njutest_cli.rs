...
extern crate self as njutest_cli;

#[path = "../../../crates/njutest-cli/src/lib.rs"]
mod product;
...
#[path = "../../../crates/njutest-cli/src/bin/cargo-njutest/main.rs"]
mod cargo_alias;
#[path = "../../../crates/njutest-cli/src/main.rs"]
mod primary;
