...
<https://github.com/P4suta/mjutest/security/advisories/new>
...
mjutest and rust-mutants run `cargo`, the project's test binaries, fuzz
targets, and mutants from the repository they are pointed at, and mjutest can
